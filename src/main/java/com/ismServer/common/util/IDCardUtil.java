...
public class IDCardUtil {
    ...
    private static int OLD_CERT_NO_LENGTH = 15;

    private static int NEW_CERT_NO_LENGTH = 18;
    ...
    public static boolean isIDCard(String certNo){
        if(certNo == null || (certNo.length() != OLD_CERT_NO_LENGTH && certNo.length() != NEW_CERT_NO_LENGTH)) {
            return false;
        }
    ...
    public static void main(String[] args) {    
         boolean mark1 = isIDCard("411526198710015114");  
         boolean mark2 = isIDCard("411524199001175125");
